...
academically by Qian \& others (\citeproc{ref-qian2005risk}{2005}). This
...
Tiletche (\citeproc{ref-maillard2010properties}{2010})).

The RPP approach has demonstrated robust performance in various studies
(Maillard \emph{et al.} (\citeproc{ref-maillard2010properties}{2010});
Chaves, Hsu, Li \& Shakernia (\citeproc{ref-chaves2011risk}{2011});
Choi, Kim \& Kim (\citeproc{ref-choi2024diversified}{2024})). However,
...
(\citeproc{ref-roncalli2013introduction}{2013})). This concept diverges
...
(\citeproc{ref-asness2012leverage}{Asness, Frazzini \& Pedersen, 2012};
...
(\citeproc{ref-costa2022data}{2022})).
